...
import Header from "../../layout/Header"; // Make sure the path matches your structure
...
const Users = () => {
  ...
  // Filter out admins so we only see normal "user" accounts in this table
                  ...
                  {normalUsers.map((user, index) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-right text-sm text-gray-500">
                        {/* Safely check for either camelCase or snake_case from MySQL */}
