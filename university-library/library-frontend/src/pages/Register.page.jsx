    ...
    <div className="flex flex-col md:flex-row h-screen bg-white">
      ...
      <div className="hidden md:flex w-full md:w-1/2 bg-black text-white flex-col justify-center items-center p-8 rounded-tr-[80px] rounded-br-[80px] z-10 shadow-2xl">
        <div className="text-center mb-12 flex flex-col items-center">
          <Library
            size={80}
            className="mb-6 text-brand-primary drop-shadow-[0_0_15px_rgba(33,212,30,0.8)]"
          />
          <h1 className="text-5xl font-bold tracking-wider mb-4">LibSys</h1>
          <p className="text-gray-400 text-lg max-w-sm leading-relaxed">
            Your premier digital library for borrowing, reading, and managing
            books.
          </p>
        </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 relative">
        <div className="w-full max-w-md">
          ...
          <h3 className="text-4xl font-bold mb-2 text-color-text-secondary">
            Sign Up
          </h3>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              ...
              Password Must be 8-16 characters containing a number, uppercase, lowercase,
